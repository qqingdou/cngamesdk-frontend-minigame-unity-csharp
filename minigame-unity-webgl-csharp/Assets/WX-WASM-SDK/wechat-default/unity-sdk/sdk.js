...
export default {
    ...
    WX_OnAddToFavorites(){
        ...
        wx.onAddToFavorites(()=>{
            moduleHelper.send('_OnAddToFavoritesCallback');
    ...
    WX_OnCopyUrl(){
        wx.offCopyUrl();
        wx.onCopyUrl(()=>{
            moduleHelper.send('_OnCopyUrlCallback');
    ...
    WX_OnHandoff(){
        wx.offHandoff();
        wx.onHandoff(()=>{
            moduleHelper.send('_OnHandoffCallback');
    ...
    WX_OnShareTimeline(){
        wx.offShareTimeline();
        wx.onShareTimeline(()=>{
            moduleHelper.send('_OnShareTimelineCallback');
